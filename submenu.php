             ...
             <ul class="top-menu">
               <li><a href="/"><i class="fas fa-home"></i></a></li>
                 <?php if($user[0]['role']==1): ?>
                  <li><a href="calllist.php"><i class="fas fa-phone-square"></i> ДУУДЛАГА</a></li>
                  <li><a href="calllist1.php"><i class="fas fa-phone-slash"></i> ХААГДСАН ДУУДЛАГУУД</a></li>
                 <li><a href="apartment.php"><i class="fas fa-user-circle"></i> ОРШИН СУУГЧДЫН БҮРТГЭЛ</a></li>
                 ...
                 <?php if($user[0]['role']==3): ?>
                  ...
                  <li><a href="calllist.php">ДУУДЛАГА</a></li>
                  <?php endif; ?>
               ...
               <?php if($user[0]['role']==4): ?>
                 ...
                 <li><a href="callbogd.php">ХААГДСАН ДУУДЛАГУУД</a></li>
             
                 <li><a href="calllist1.php">ХААГДСАН ДУУДЛАГУУД</a></li>
