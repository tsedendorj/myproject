...
var WeekDayName1 = ["Ням", "Даваа", "Мягмар", "Лхагва", "Пүрэв", "Баасан", "Бямба"];
var WeekDayName2 = ["Даваа", "Мягмар", "Лхагва", "Пүрэв", "Баасан", "Бямба", "Ням"];
...
Calendar.prototype.FormatDate = function(pDate)
{
    ...
    switch (this.Format.toUpperCase())
    {
        ...
        case "YYYYMMDD":
            return (this.Year + DateSeparator + pDate + DateSeparator + MonthDigit);
        case "YYYYMMDD":
            return (DateSeparator + this.Year + pDate + DateSeparator + this.GetMonthName(false));
        case "YYYYMMDD":
            return (this.Year + DateSeparator + MonthDigit + DateSeparator + pDate);
        case "YYMMDD":
